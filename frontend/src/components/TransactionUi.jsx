...
const TransactionUi = ({ data, toggleModal }) => {
    return (
        <div className="col-span-full dark:bg-gray-800 rounded-xl p-3">
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3">
                {data?.map((transaction) => (
                    <div key={transaction._id} className="bg-white dark:bg-gray-900 p-4 shadow-sm rounded-xl">
                        <h3 className="font-semibold text-gray-700 dark:text-gray-300">
                            {transaction.user.substring(0, 10)}...
                        </h3>
                        ...
                        <div className="mt-3 flex justify-end gap-2">
                            <button
                                ...
                                onClick={() => toggleModal('delete', true, transaction._id)}
                            >
                                <svg
