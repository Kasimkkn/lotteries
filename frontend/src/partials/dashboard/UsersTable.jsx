...
function UsersTable({ data, onViewClick, onDeleteClick }) {
                ...
                data?.map(customer => {
                  return (
                    <tr key={customer._id}>
                      <td className="p-2 whitespace-nowrap">
                        <div className="flex items-center">
                          <div className="w-10 h-10 shrink-0 mr-2 sm:mr-3">
                            <img className="rounded-full" src={Image01} width="40" height="40" alt={customer.username} />
                          </div>
                          <div className="font-medium text-gray-800 dark:text-gray-100">{customer.username}</div>
                        </div>
                      </td>
                      <td className="p-2 whitespace-nowrap">
                      ...
                      <td className="p-2 whitespace-nowrap">
                        <div className="text-left font-medium text-green-500">{customer.balance}</div>
                      </td>
                      <td className="p-2 whitespace-nowrap">
                        <div className="flex items-center justify-center gap-2">
                          <button onClick={() => onViewClick(customer)} className="flex justify-center items-center">
                            <svg
                          ...
                          <button onClick={() => onDeleteClick(customer._id)} className="flex justify-center items-center">
                            <svg
